...
@section('content')
            ...
            <div class="position-relative d-flex align-items-center ">
                ...
                <div class="dropdown showStatus">
                    ...
                    <select class="form-select showStatus text-dark fs-6" aria-label="Default select example"
                        ...
                        <option value="For bos review" {{ $case->status === 'For bos review' ? 'selected' : '' }}>For bos
                            review</option>
                        <option value="Need information" {{ $case->status === 'Need information' ? 'selected' : '' }}>Need
                            information</option>
    ...
    <div class="row present">
            ...
            <table id="table-one" class="table">
                ...
                <tr class="dataTr">
                    <td colspan="3">Name: <input type="text" name="name" id="name" class="tableInput w-75"
                            value="{{ $case->name }}"><p></p></td>
                    <td>D.O.B: <input type="date" name="dob" id="dob" class="tableInput w-50"
                            onchange="calculateAge()" value="{{ $case->dob }}"><p></p></td>
                    ...
                    <td>
                            <select name="state" id="state" class="form-select w-50">
                                ...
                                @foreach($states as $state)
                                    <option value="{{$state->name}}" {{ $case->state == $state->name ? 'selected' : '' }}>{{$state->name}}</option>
                                @endforeach
                            </select>
                        </td>
                ...
                <tr class="dataTr">
                    <td colspan="4">Email: 
                        <input type="email" name="email" id="email" class="tableInput w-75" placeholder="xxxxx@xxxxxxxxx.xxx" value="{{ $case->email }}">
                    <span id="emailError" style="color:red; display:none;">Please enter a valid email address.</span>
                    </td>
                    <td>Phone: 
                        <input type="text" name="phone" id="phone" placeholder="(555) 555-1234" class="tableInput w-50" value="{{ $case->phone }}">
            ...
            <table id="table-two retirement_system" class="table">
                ...
                <tr class="dataTr">
                    ...
                    <td colspan="3">
                        ...
                        <input type="date" name="retirement_system_fers_transfer" id="retirement_system_fers_transfer"
                            class="tableInput w-50"
            ...
            <table id="table-four" class="table">
                ...
                <tr class="dataTr">
                    <td style="vertical-align:middle" class="text-center">What are the employee service computation
                        dates(SCD’s)?</td>
                    <td colspan="3">
                        LSCD(Leave SCD-from paystub / LES) :<input type="text" name="lscd" class="tableInput w-25"
                            value="{{ $case->lscd }}"><br>
                ...
                <tr class="dataTr">
                    ...
                    <td>
                        <input type="radio" id="fed" name="retirement_type"
                            value="fully_eligible_disability" {{ $case->retirement_type == "fully_eligible_disability" ? 'checked' : '' }}>
                        <label for="fed">Fully Eligible/Disability</label>
                    </td>
                    <td> <label
                            for="date"> Date:</label> <input type="date" name="retirement_type_date"
                            id="retirement_type_date" onchange="calculateRetirmentAge(); calculateYoSDollar()"
                            class="tableInput w-50" value={{ $case->retirement_type_date }}>
                            <br><span id="retireDateError" class="error" style="display: none;">Retirement date must be greater
                    ...
                    <td> <label
                            for="age">At Age:</label> <input type="text" name="retirement_type_age"
                            id="retirement_type_age" class="tableInput w-50" value="{{ $case->retirement_type_age }}">
                    </td>
                </tr>
                <tr class="dataTr">
                    <td><input value="first_eligible" type="radio" id="fem" name="retirement_type"
                            {{ $case->retirement_type == "first_eligible" ? 'checked' : '' }}> <label for="fem">FIRST
                            Eligible (MRA+10
                            Retirement)</label></td>
                    <td colspan="1"> </td>
                    <td><input value="voluntary" type="radio" name="retirement_type" id="ve" {{ $case->retirement_type == "voluntary" ? 'checked' : '' }}>
                        <label for="ve">Voluntary (EARLY OUT)–Offer
                            Date:</label> <input type="date" name="retirement_type_voluntary" class="tableInput w-25"
                            value="{{ $case->retirement_type_voluntary }}"></td>
                    <!-- <td> </td> -->
                </tr>
                        ...
                        <div class="dropdown">
                            <select id="current_hours_option" name="current_hours_option" class="form-select">
                                ...
                                <option value="yes" {{ $case->current_hours_option === 'yes' ? 'selected' : '' }}>
                                    Yes</option>
                                <option value="no"
                                    {{ $case->current_hours_option === 'no' ? 'selected' : '' }}>No
                                </option>
                            </select>
                        </div>
                    </td>
                    ...
                    <td class="">
                        <div class="dropdown">
                            {{-- <a class="btn dropdown-toggle" role="button" id="showStatus" data-bs-toggle="dropdown"
                                ...
                                <ul class="dropdown-menu" aria-labelledby="showStatus">
                            ...
                            <select id="current_leave_option" name="current_leave_option" class="form-select">
                                <option value="">select an option</option>
                                <option value="yes" {{ $case->current_leave_option === 'action' ? 'selected' : '' }}>
                                    Yes</option>
                                <option value="no"
                                    {{ $case->current_leave_option === 'another_action' ? 'selected' : '' }}>No
                                </option>
                            </select>
                    ...
                    <td class='d-flex align-items-center'>Will the employee’s High-3 be based on their CURRENT salary?
                        <div class="dropdown">
                            ...
                            <select id="income_employee_option" name="income_employee_option" class="form-select">
                                <option value="yes" {{ $case->income_employee_option == 'yes' ? 'selected' : '' }}>Yes
                                </option>
                                <option value="no" {{ $case->income_employee_option == 'no' ? 'selected' : '' }}>No
                                </option>
                            </select>

                        </div>
                    </td>
                    <td> Current Salary Amount $ <input type="text" name="salary_1" class="tableInput w-25 numberInput"
                            value="{{ $case->salary_1 }}"> </td>
                </tr>
                <tr class="dataTr">
                    <td>If NOT, what are the salary amounts to be used? $<input type="text" name="salary_2"
                            class="tableInput w-25 numberInput" value="{{ $case->salary_2 }}"> $<input type="text"
                            name="salary_3" class="tableInput w-25 numberInput" value="{{ $case->salary_3 }}"></td>
                    <td>$<input type="text" name="salary_4" class="tableInput w-50 numberInput" value="{{ $case->salary_4 }}">
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table id="table-eight" class="table">
                ...
                <tr class="dataTr">
                    <td style="display: flex;align-items: baseline;">Is the employee’s Spouse and/or Former Spouse be
                        ...
                        <div class="dropdown">
                            {{-- <a class="btn dropdown-toggle" role="button" id="employeeSpouse" data-bs-toggle="dropdown" aria-expanded="false">
                                    Please Select
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="employeeSpouse">
                            ...
                            <select id="employee_spouse" name="employee_spouse" class="form-select">
                                ...
                                <option value="no" {{ $case->employee_spouse === 'no' ? 'selected' : '' }}>No</option>
                            </select>

                        </div>

                        <div class="dropdown">
                            {{-- <a class="btn dropdown-toggle" role="button" id="employeeSpouseStatus" data-bs-toggle="dropdown" aria-expanded="false">
                                    Please Select
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="employeeSpouseStatus">
                                <li><a class="dropdown-item" href="#"  data-value="current">Current spouse</a></li>
                                <li><a class="dropdown-item" href="#"  data-value="former">Former spouse</a></li> --}}


                            <select id="employee_spouse_status" name="employee_spouse_status" class="form-select">
                                <option value="current spouse"
                                    {{ $case->employee_spouse_status === 'current spouse' ? 'selected' : '' }}>Current
                                    spouse</option>
                                <option value="former spouse"
                                    {{ $case->employee_spouse_status === 'former spouse' ? 'selected' : '' }}>Former spouse
                                </option>
                            </select>
        ...
        <div class="col-12">
            <table id="table-nine" class="table">
                ...
                <tr class="dataTr">
                    <td style="display: flex;align-items: baseline;"> Is the employee ELIGIBLE for Social Security at age
                        62?
                        <div class="dropdown">
                            ...
                            <select id="employee_eligible" name="employee_eligible" class="form-select">
                                ...
                                <option value="net yet" {{ $case->employee_eligible == 'net yet' ? 'selected' : '' }}>Net
                                    yet</option>
                    ...
                    <td>Amount of SS at 62 $ <input type="text" name="amount_1" class="tableInput w-50 numberInput"
                            value="{{ $case->amount_1 }}"> </td>
                </tr>
                <tr class="dataTr">
                    <td>What age does the employee estimate begin SS Income? <input type="text" name="amount_2"
                            class="tableInput w-25 numberInput" value="{{ $case->amount_2 }}"></td>
                    ...
                    <td class='d-flex align-items-center'>
                        ...
                        <div class="dropdown">
                            ...
                            <select id="employee_work" name="employee_work" class="form-select">
                                <option value="yes" {{ $caseOFST->employee_work == 'yes' ? 'selected' : '' }}>Yes</option>
                                <option value="no" {{ $caseOFST->employee_work === 'no' ? 'selected' : '' }}>No</option>
                            </select>
                    ...
                    <td style="display: flex;align-items: center;border:0;height:6rem">
                        ...
                        <div class="dropdown">
                            ...
                            <select id="non_deduction_service" name="non_deduction_service" class="form-select">
                                <option value="yes" {{ $caseOFST->non_deduction_service === 'yes' ? 'selected' : '' }}>Yes
                                </option>
                                <option value="no" {{ $caseOFST->non_deduction_service === 'no' ? 'selected' : '' }}>No
                                </option>
                            </select>
                    ...
                    <td> What were the dates of service? <input type="text" name="non_deduction_service_date"
                        ...
                        <div class='d-flex align-items-center'>Was a deposit paid?
                            <div class="dropdown">
                                ...
                                <select id="non_deduction_service_deposit" name="non_deduction_service_deposit" class="form-select">
                                    <option value="yes"
                                        {{ $caseOFST->non_deduction_service_deposit === 'yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="no"
                                        {{ $caseOFST->non_deduction_service_deposit === 'no' ? 'selected' : '' }}>No</option>
                                </select>
            ...
            <tr class="dataTr">
                ...
                <td style='display: flex;align-items: baseline;'> Did the employee ever have a Break in Service of
                    ...
                    <select id="break_in_service" name="break_in_service" class="form-select">
                        <option value="yes" {{ $caseOFST->break_in_service === 'yes' ? 'selected' : '' }}>Yes</option>
                        <option value="no" {{ $caseOFST->break_in_service === 'no' ? 'selected' : '' }}>No</option>
                    </select>

    </div>
    </td>
    <td> Dates of service PRIOR to the BREAK <input type="date" name="break_in_service_date_1" class="tableInput w-25"
            value="{{ $caseOFST->break_in_service_date_1 }}"> to <input type="date" name="break_in_service_date_2"
            class="tableInput w-25" value="{{ $caseOFST->break_in_service_date_2 }}"> Date employee RETURNED to federal
    ...
    <tr class="dataTr">
        ...
        <td style="display: flex;align-items: baseline;"> Did the employee take a Refund of their retirement contributions
            during their break of service?
            <div class="dropdown">


                <select id="break_in_service_refund" name="break_in_service_refund" class="form-select">
                    <option value="yes" {{ $caseOFST->break_in_service_refund === 'yes' ? 'selected' : '' }}>Yes</option>
                    <option value="no" {{ $caseOFST->break_in_service_refund === 'no' ? 'selected' : '' }}>No</option>
                </select>
    ...
    <div class="col-12">
        ...
        <table id="table-thirteen" class="table">
                ...
                <td style='display: flex;align-items: baseline;'>Has the employee ever had Military service?
                    <div class="dropdown">
                        ...
                        <select id="military_service" name="military_service" class="form-select">
                            <option value="yes" {{ $caseMST->military_service === 'yes' ? 'selected' : '' }}>Yes</option>
                            <option value="no" {{ $caseMST->military_service === 'no' ? 'selected' : '' }}>No</option>
                        </select>
            ...
            <tr class="dataTr">
                <td style="display: flex;align-items: baseline;"><input type="checkbox" id="add" class='me-1'
                        {{ $caseMST->military_service_active_duty ? 'checked' : '' }}> <label for="add"> Active-Duty -
                        Deposit
                        paid?</label>
                    <div class="dropdown">


                        <select id="military_service_active_duty" name="military_service_active_duty" class="form-select">
                            <option value="yes" {{ $caseMST->military_service_active_duty === 'yes' ? 'selected' : '' }}>
                                Yes</option>
                            <option value="no" {{ $caseMST->military_service_active_duty === 'no' ? 'selected' : '' }}>
                                No</option>
                        </select>
                ...
                <td>
                    Dates of service? <input type="date" name="military_service_active_duty_date_1"
                        class="tableInput w-25" value="{{ $caseMST->military_service_active_duty_date_1 }}"> to <input
                        type="date" name="military_service_active_duty_date_2" class="tableInput w-25"
                ...
                <td style="display: flex;align-items: baseline;"><input type="checkbox"
                    ...
                    <div class="dropdown">
                        ...
                        <select id="military_service_reserve" name="military_service_reserve" class="form-select">
                            <option value="yes" {{ $caseMST->military_service_reserve === 'yes' ? 'selected' : '' }}>Yes
                            </option>
                            <option value="no" {{ $caseMST->military_service_reserve === 'no' ? 'selected' : '' }}>No
                            </option>
                        </select>
                    </div>
                </td>
            ...
            <tr class="dataTr">
                ...
                <td style="display: flex;align-items: baseline;"> <input type="checkbox"
                        {{ $caseMST->military_service_academy ? 'checked' : '' }} id="add" class='me-1'> <label
                        for="add"> Academy - Deposit
                        paid?</label>
                    <div class="dropdown">


                        <select id="military_service_academy" name="military_service_academy" class="form-select">
                            <option value="yes" {{ $caseMST->military_service_academy == 'yes' ? 'selected' : '' }}>Yes
                            </option>
                            <option value="no" {{ $caseMST->military_service_academy == 'no' ? 'selected' : '' }}>No
                            </option>
                        </select>
                    </div>
                </td>
                ...
                <td style='display: flex;align-items: baseline;'>Did the employee Retire from Military service?
                    <div class="dropdown">
                        ...
                        <select id="military_service_retire" name="military_service_retire" class="form-select">
                            <option value="yes" {{ $caseMST->military_service_retire == 'yes' ? 'selected' : '' }}>Yes
                            </option>
                            <option value="no" {{ $caseMST->military_service_retire == 'no' ? 'selected' : '' }}>No
                            </option>
                        </select>
                    </div>
                </td>
            ...
            <tr class="dataTr">
                <td>
                    <input type="checkbox" id="ady" name="military_service_active_duty"
                        ...
                        name="military_service_reserves" {{ $caseMST->military_service_reserves ? 'checked' : '' }}> <label
                        for="revse">Reserves</label>
                </td>
                <td>
                    Amount of VA pay $<input type="text" name="military_service_amount" class="tableInput w-50 numberInput"
                        value="{{ $caseMST->military_service_amount }}"> /month
                </td>
            </tr>
            <tr class="dataTr">
                <td colspan="12">
    ...
    <div class="col-12">
        ...
        <table id="table-fourteen" class="table">
            ...
            <tr class="dataTr">
                ...
                <td colspan="2">$<input type="text" name="contribute_pp" class="tableInput w-50 numberInput"
                        value="{{ $caseTSP->contribute_pp }}">/PP </td>
                <td colspan="2"><input type="text" name="contribute_pp_percentage" class="tableInput  w-50"
            ...
            <tr class="dataTr">
                ...
                <td colspan="2">$<input type="text" name="contribute_tsp_pp" class="tableInput  w-50 numberInput"
                        value="{{ $caseTSP->contribute_tsp_pp }}"> /PP </td>
                <td colspan="2"><input type="text" name="contribute_tsp_pp_percentage" class="tableInput  w-50"
                ...
                <td width="50%" class=''>
                    <div class='d-flex align-items-baseline'>Does the employee have any TSP loan(s)? <div
                            ...
                            <select id="contribute_tsp_loan" name="contribute_tsp_loan" class="form-select">
                                <option value="yes" {{ $caseTSP->contribute_tsp_loan == 'yes' ? 'selected' : '' }}>Yes
                                </option>
                                <option value="no" {{ $caseTSP->contribute_tsp_loan == 'no' ? 'selected' : '' }}>No
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <input type="checkbox" id="g" name="contribute_tsp_loan_gen" value="general"
                        {{ $caseTSP->contribute_tsp_loan_gen ? 'checked' : '' }}> <label for="g">General</label>
                    <br>
                    <input type="checkbox" id="r" name="contribute_tsp_res" value="residential"
                        {{ $caseTSP->contribute_tsp_res ? 'checked' : '' }}> <label for="r">Residential</label>
                </td>
                <td></td>
                <td width="50%">
                    How much does the employee pay for their loan(s)?<input type="text" name="contribute_pay_pp"
                        class="tableInput" style="width: 10%;" value="{{ $caseTSP->contribute_pay_pp }}">/PP $<input
                        type="text" name="contribute_pay_pp_value" class="tableInput numberInput" style="width: 10%;"
                        value="{{ $caseTSP->contribute_pay_pp_value }}">/PP <br>
                    How much is owed for each loan? $<input type="text" name="contribute_own_loan"
                        class="tableInput w-25 numberInput" value="{{ $caseTSP->contribute_own_loan }}"> $<input type="text"
                        name="contribute_own_loan_2" class="tableInput w-25 numberInput"
        ...
        <table id="table-sixteen" class="table">
            ...
            <tr class="dataTr">
                <td>When does the employee need access to the TSP? <br>
                    ...
                    <input type="checkbox" name="" id="atage" {{ $caseTSP->employee_at_age ? 'checked' : '' }}>
                    <label for="atage">At
                    ...
                    <div class='d-flex align-items-baseline'>Is protecting their $$ from market loss important?
                        <div class="dropdown">
                            ...
                            <select id="employee_loss" name="employee_loss" class="form-select">
                                ...
                                <option value="no" {{ $caseTSP->employee_loss == 'no' ? 'selected' : '' }}>No</option>
                            </select>
                        </div>
                    </div>
                    <br>
        ...
        <table id="table-seventeen" class="table">
            ...
            <tr class="dataTr">
                <td>
                    ...
                    <br>
                    If so, what is that amount? $<input type="text" name="goal_amount" value="{{$caseTSP->goal_amount}}" class="tableInput w-25 numberInput"
                        ><br>
                    What is the purpose for the TSP?<input type="text" name="goal_tsp" value="{{$caseTSP->goal_tsp}}" class="tableInput w-25"
                        ><br>
                    What would the employee like to do after they retire?<input type="text" name="goal_retirement" value="{{$caseTSP->goal_retirement}}"
                    ...
                    How much does the employee need to live comfortably?<input type="text" name="goal_comfor" value="{{$caseTSP->goal_comfor}}"
                        class="tableInput w-25" ><br>
                    <div class='d-flex align-items-baseline'>
                        ...
                        <div class="dropdown">
                            <select id="goal_professional" name="goal_professional" class="form-select">
                                <option value="yes"
                                    {{ $caseTSP->goal_professional == 'yes' ? 'selected' : '' }}>Yes</option>
                                <option value="no"
                                    {{ $caseTSP->goal_professional == 'no' ? 'selected' : '' }}>No</option>
                            </select>
    ...
    <div class="col-sm-12 col-md-6">
        <table id="table-eighteen" class="table">
            ...
            <tr class="dataTr">
                <td>G</td>
                <td><input type="number" name="g_name" value="{{$caseTSP->g_name}}" class="tableInput w-100 number-input">
                </td>
                <td><input type="number" name="g_value" value="{{$caseTSP->g_value}}" class="tableInput w-75 percentage-input"
                        > %</td>
            </tr>
            <tr class="dataTr">
                <td>F</td>
                <td><input type="number" name="f_name" value="{{$caseTSP->f_name}}"  class="tableInput w-100 number-input" >
                </td>
                <td><input type="number" name="f_value" value="{{$caseTSP->f_value}}" class="tableInput w-75 percentage-input"
                        > %</td>
            </tr>
            <tr class="dataTr">
                <td>C</td>
                <td><input type="number" name="c_name" value="{{$caseTSP->c_name}}" class="tableInput w-100 number-input" >
                </td>
                <td><input type="number" name="c_value" value="{{$caseTSP->c_value}}" class="tableInput w-75 percentage-input"
                        > %</td>
            </tr>
            <tr class="dataTr">
                <td>S</td>
                <td><input type="number" name="s_name" value="{{$caseTSP->s_name}}" class="tableInput w-100 number-input" >
                </td>
                <td><input type="number" name="s_value" value="{{$caseTSP->s_value}}" class="tableInput w-75 percentage-input"
                        > %</td>
            </tr>
            <tr class="dataTr">
                <td>I</td>
                <td><input type="number" name="i_name"  value="{{$caseTSP->i_name}}" class="tableInput w-100 number-input" >
                </td>
                <td><input type="number" name="i_value" value="{{$caseTSP->i_value}}" class="tableInput w-75 percentage-input"
                        > %</td>
            </tr>
            <tr class="dataTr">
                <td>L Income</td>
                <td><input type="number" name="l_income" value="{{$caseTSP->l_income}}" class="tableInput w-100 number-input"
                        ></td>
                <td><input type="number" name="l_income_value" value="{{$caseTSP->l_income_value}}" class="tableInput w-75 percentage-input"
                        > %</td>
            </tr>
            <tr class="dataTr">
                <td>L 2025</td>
                <td><input type="number" name="l_2025" value="{{$caseTSP->l_2025}}" class="tableInput w-100 number-input" >
                </td>
                <td><input type="number" name="l_2025_value" value="{{$caseTSP->l_2025_value}}" class="tableInput w-75 percentage-input"
                        > %</td>
            </tr>
            <tr class="dataTr">
                <td>L 2030</td>
                <td><input type="number" name="l_2030" value="{{$caseTSP->l_2030}}" class="tableInput w-100 number-input">
                </td>
                <td><input type="number" name="l_2030_value" value="{{$caseTSP->l_2030_value}}" class="tableInput w-75 percentage-input"
                       > %</td>
            </tr>
            <tr class="dataTr">
                <td>L 2035</td>
                <td><input type="number" name="l_2035" value="{{$caseTSP->l_2035}}" class="tableInput w-100 number-input" >
                </td>
                <td><input type="number" name="l_2035_value" value="{{$caseTSP->l_2035_value}}" class="tableInput w-75 percentage-input"
                        > %</td>
            </tr>
            <tr class="dataTr">
                <td>L 2040</td>
                <td><input type="number" name="l_2040" value="{{$caseTSP->l_2040}}" class="tableInput w-100 number-input" >
                </td>
                <td><input type="number" name="l_2040_value" value="{{$caseTSP->l_2040_value}}" class="tableInput w-75 percentage-input"
                        > %</td>
            </tr>
            <tr class="dataTr">
                <td>L 2045</td>
                <td><input type="number" name="l_2045" value="{{$caseTSP->l_2045}}" class="tableInput w-100 number-input" >
                </td>
                <td><input type="number" name="l_2045_value" value="{{$caseTSP->l_2045_value}}" class="tableInput w-75 percentage-input"
                        > %</td>
            </tr>
            <tr class="dataTr">
                <td>L 2050</td>
                <td><input type="number" name="l_2050" value="{{$caseTSP->l_2050}}" class="tableInput w-100 number-input">
                </td>
                <td><input type="number" name="l_2050_value" value="{{$caseTSP->l_2050_value}}" class="tableInput w-75 percentage-input"
                        > %</td>
            </tr>
            <tr class="dataTr">
                <td>L 2055</td>
                <td><input type="number" name="l_2055" value="{{$caseTSP->l_2055}}" class="tableInput w-100 number-input" >
                </td>
                <td><input type="number" name="l_2055_value" value="{{$caseTSP->l_2055_value}}" class="tableInput w-75 percentage-input"
                        > %</td>
            </tr>
            <tr class="dataTr">
                <td>L 2060</td>
                <td><input type="number" name="l_2060" value="{{$caseTSP->l_2060}}" class="tableInput w-100 number-input" >
                </td>
                <td><input type="number" name="l_2060_value" value="{{$caseTSP->l_2060_value}}" class="tableInput w-75 percentage-input"
                        > %</td>
            </tr>
            <tr class="dataTr">
                <td>L 2065</td>
                <td><input type="number" name="l_2065" value="{{$caseTSP->l_2065}}" class="tableInput w-100 number-input" >
                </td>
                <td><input type="number" name="l_2065_value" value="{{$caseTSP->l_2065_value}}" class="tableInput w-75 percentage-input"
                        > %</td>
            </tr>
            <tr class="dataTr">
                <td>Total</td>
                <td><input type="number" name="total_amount" id="total_amount" value="{{$caseTSP->total_amount}}" class="tableInput w-100"
                        >$0.00</td>
                <td><input type="number" name="total_amount_percentage" id="total_amount_percentage" value="{{$caseTSP->total_amount_percentage}}" class="tableInput w-75 "
                        > %
            ...
            <tr class="dataTr">
                <td>
                    <div class='d-flex align-items-baseline'>
                        ...
                        <div class="dropdown">
                            <select id="insurance" name="insurance" class="form-select">
                                <option value="">select an option</option>
                                <option value="yes" {{ $caseInsurancePlan->insurance == 'yes' ? 'selected' : '' }}>Yes
                                </option>
                                <option value="no" {{ $caseInsurancePlan->insurance == 'no' ? 'selected' : '' }}>No
                                </option>
                            </select>
                    ...
                    <div class='d-flex align-items-baseline'>
                        ...
                        <div class="dropdown">
                            <select id="insurance_emloyee" name="insurance_emloyee" class="form-select">
                                <option value="">select an option</option>
                                <option value="yes"
                                    {{ $caseInsurancePlan->insurance_emloyee == 'yes' ? 'selected' : '' }}>Yes</option>
                                <option value="no"
                    ...
                    <div class='d-flex align-items-baseline'>
                        ...
                        <div class="dropdown">
                            <select id="insurance_retirement" name="insurance_retirement" class="form-select">
                                <option value="">select an option</option>
                                <option value="yes"
                                    {{ $caseInsurancePlan->insurance_retirement == 'yes' ? 'selected' : '' }}>Yes</option>
                                <option value="no"
                                    {{ $caseInsurancePlan->insurance_retirement == 'no' ? 'selected' : '' }}>No</option>
                            </select>
                    ...
                    <div class='d-flex align-items-baseline'>
                        ...
                        <div class="dropdown">
                            <select id="insurance_employee_dependent" name="insurance_employee_dependent" class="form-select">
                                <option value="">select an option</option>
                                <option value="yes"
                                    {{ $caseInsurancePlan->insurance_employee_dependent == 'yes' ? 'selected' : '' }}>Yes
                                </option>
                                <option value="no"
                                    {{ $caseInsurancePlan->insurance_employee_dependent == 'no' ? 'selected' : '' }}>No
                                </option>
                            </select>
                ...
                <td>What coverage does the employee have?<br>
                    <div>
                        <input 
                            type="radio" name="insurance_coverage_value" {{ $caseInsurancePlan->insurance_coverage_value == 'basic_option' ? 'selected' : '' }} value="basic_option" class="me-2"
                            id="bs">
                        <label for="bs">Basic</label>
                    </div>
                    <div>
                        <input 
                            type="radio" name="insurance_coverage_value" {{ $caseInsurancePlan->insurance_coverage_value == 'a_option' ? 'selected' : '' }} value="a_option" class="me-2"
                            id="opa">
                        <label for="opa">Option A</label>
                    </div>
                    <div>
                        <input 
                            type="radio" name="insurance_coverage_value" {{ $caseInsurancePlan->insurance_coverage_value == 'b_option' ? 'selected' : '' }} value="b_option" class="me-2"
                            id="obx">
                        <label for="obx">Option B x</label><input type="number" value="{{$caseInsurancePlan->option_b_value}}" name="option_b_value"
                             min="1" max="5"
                            class="tableInput w-25">
                    </div>
                    <div>
                        <input 
                            type="radio" name="insurance_coverage_value" {{ $caseInsurancePlan->insurance_coverage_value == 'c_option' ? 'selected' : '' }} value="c_option" class="me-2"
                            id="ocx">
                        <label for="ocx">Option C x</label> <input type="number" min="1" max="5"
                            name="insurance_employee_coverage_c" value="{{$caseInsurancePlan->insurance_employee_coverage_c}}" class="tableInput w-25"
                            ><br>
                    </div>

                    What is the FEGLI premium? $
                    <input type="text" name="insurance_employee_coverage_pp" value="{{$caseInsurancePlan->insurance_employee_coverage_pp}}" class="tableInput w-25 numberInput"
                        >/PP <br>
                    Age(s) of dependent child(ren)<input type="text" name="insurance_employee_coverage_age" value="{{$caseInsurancePlan->insurance_employee_coverage_age}}"
                        class="tableInput w-25" ><br>
                    Age of child(ren) incapable of self-support<input type="text"
                        name="insurance_employee_coverage_self_age" value="{{$caseInsurancePlan->insurance_employee_coverage_self_age}}" class="tableInput w-25"
                        ><br>
                    <div class='d-flex align-items-baseline'>
                        ...
                        <div class="dropdown">
                            <select id="insurance_analysis" name="insurance_analysis" class="form-select">
                                <option value="yes"
                                    {{ $caseInsurancePlan->insurance_analysis == 'yes' ? 'selected' : '' }}>Yes</option>
                                <option value="no"
                    ...
                    <div class="d-flex align-items-baseline">
                        ...
                        <div class="dropdown">
                            <select id="federal" name="federal" class="form-select">
                                <option value="yes" {{ $caseInsurancePlan->federal == 'yes' ? 'selected' : '' }}>Yes
                                </option>
                                <option value="no" {{ $caseInsurancePlan->federal == 'no' ? 'selected' : '' }}>No
                                </option>
                            </select>
                        ...
                        <div class="dropdown">
                            <select id="plan_type" name="plan_type" class="form-select">
                                <option value="self" {{ $caseInsurancePlan->plan_type == 'self' ? 'selected' : '' }}>
                                    Self</option>
                                <option value="self+1" {{ $caseInsurancePlan->plan_type == 'self+1' ? 'selected' : '' }}>
                                    Self+1</option>
                        ...
                        FEHB premium $<input type="text" name="premium" value="{{$caseInsurancePlan->premium}}" class="tableInput numberInput" style="width: 20%;"
                            >
                        /pp
                    </div>
                </td>
            ...
            <tr class="dataTr" style='vertical-align:baseline'>
                <td>
                    ...
                    <div class='d-flex align-items-baseline'>
                        ...
                        <div class="dropdown">
                            <select id="coverage_retirement_dependent" name="coverage_retirement_dependent" class="form-select">
                                <option value="yes"
                ...
                <td>
                    ...
                    <input type="text" name="coverage_retirement_insurance" value="{{$caseInsurancePlan->coverage_retirement_insurance}}" class="tableInput w-25"
                        ><br><br>
                    Why? <input type="text" name="coverage_retirement_insurance_why" value="{{$caseInsurancePlan->coverage_retirement_insurance_why}}" class="tableInput w-25"
                        ><br><br>
                    Who ?<input type="checkbox" name="coverage_retirement_insurance_spouse" value="{{$caseInsurancePlan->coverage_retirement_insurance_spouse}}" value="spouse"
                        class="mx-2" id="spu"
                        > <label
                        for="spu">Spouse</label>
                    <input type="checkbox" name="coverage_retirement_insurance_child" value="{{$caseInsurancePlan->coverage_retirement_insurance_child}}" value="child(ren)"
                        class="me-2" id="chl"
                        > <label
                        for="chl">Child(ren)</label>
                    <input type="checkbox" name="coverage_retirement_insurance_both" value="{{$caseInsurancePlan->coverage_retirement_insurance_both}}" value="both" class="me-2"
                        id="bth" >
                ...
                <td colspan="12">
                    <div class="d-flex align-items-baseline">
                        ...
                        <div class='d-flex align-items-baseline'>
                            ...
                            Dental premium $<input type="text" name="dental_premium" value="{{$caseInsurancePlan->dental_premium}}" class="tableInput numberInput"
                                style="width: 18%;" > /PP
                        </div>
                    </div>
        ...
        <td colspan="12">
            <div class="d-flex align-items-baseline">
                ...
                <div class='d-flex align-items-baseline'>
                    ...
                    Vision premium $<input type="text" name="vision_preminum" value="{{$caseInsurancePlan->vision_preminum}}" class="tableInput numberInput"
                        style="width: 18%;" >/PP
                </div>
            </div>
    ...
    <tr class="dataTr">
        <td colspan="12">FYI: If there is a combined premium for Dental and Vision, we will only be able
            to show the total cost. <span class="ms-2">Dental/Vision $</span><input type="text"
                name="vision_total_cost" value="{{$caseInsurancePlan->vision_total_cost}}" class="tableInput w-25 numberInput"
                >/PP
        </td>
    </tr>
    </table>
                    ...
                    <div class="d-flex align-items-baseline">
                        ...
                        <div class="dropdown">
                            ...
                            <select id="insurance_program" name="insurance_program" class="form-select">
                                <option value="yes"
                                    {{ $caseInsurancePlan->insurance_program == 'yes' ? 'selected' : '' }}>Yes</option>
                                <option value="no"
                        ...
                        Purchase age <input type="number" name="insurance_age" value="{{$caseInsurancePlan->insurance_age}}" class="tableInput"
                            style="width: 18%;" >Premium $<input
                            type="text" name="insurance_purchase_premium" value="{{$caseInsurancePlan->insurance_purchase_premium}}" class="tableInput numberInput" style="width: 18%;"
                            >/PP
                    </div>
                </td>
            </tr>
                        ...
                        <div class="dropdown">
                            <select id="insurance_program_retirement" name="insurance_program_retirement" class="form-select">
                                <option value="yes"
                                    ...
                                    Yes</option>
                                <option value="no"
                                    {{ $caseInsurancePlan->insurance_program_retirement == 'no' ? 'selected' : '' }}>No
                                </option>
                            </select>


                        </div>
                        Plans to keep in retirement? <input type="text" name="insurance_program_plan" value="{{$caseInsurancePlan->insurance_program_plan}}"
                            class="tableInput" style="width: 15%;"
                            >Daily Benefit Amount<input
                            type="text" name="insurance_program_daily" value="{{$caseInsurancePlan->insurance_program_daily}}" class="tableInput" style="width: 15%;"
                            >'day
                </td>
    </div>
    </tr>
    <tr class="dataTr">
        <td colspan="12">
            <div class="d-flex align-items-baseline">
                ...
                Purpose of coverage <input type="text" name="insurance_purpose_covergae" value="{{$caseInsurancePlan->insurance_purpose_covergae}}" class="tableInput"
                ...
                <div class="dropdown">
                    ...
                    <select id="insurance_program_purpose" name="insurance_program_purpose" class="form-select">
                        ...
                        <option value="FPO"
                            {{ $caseInsurancePlan->insurance_program_purpose == 'FPO' ? 'selected' : '' }}>FPO</option>
                    </select>
                </div>
                Maximum Lifetime Benefit $<input type="text" id="max_lifetime" value="{{$caseInsurancePlan->max_lifetime}}" name="max_lifetime" class="tableInput numberInput"
                    style="width: 15%;" >
            </div>
        </td>
    </tr>
...
// end email validations
        ...
        jQuery.ajax({
            url:"{{route('share.caseUpdate',$case->id)}}",
            type:'put',
