            ...
            {{-- <div class="rectangle-parent">
                <div class="input-group mb-3">
                  <span class="" id="basic-addon1"><img class="iconlylight-outlinemessage" alt=""
                      src="/images/signin/iconlylightoutlinemessage.svg" /></span>
                ...
                @enderror
                  ...
                  <a type="submit" href='/' class="rectangle-button text-decoration-none" style='width: 35%;height: 38px;background: linear-gradient(219.34deg, #0570e0, #022181);text-align:center;'>Login</a>
              </div> --}}
