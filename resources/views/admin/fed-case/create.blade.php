    ...
    <form name="fedForm" id="fedForm">
            ...
            <div class="col-12">
                <table id="table-five" class="table">
                    ...
                    <tr class="dataTr">
                        ...
                        <td> <label for="date"> Desired Retirement Date:</label> <input type="date" name="retirement_type_date"
                    ...
                    <tr class="dataTr">
                        <td style="display: flex;align-items: baseline;">Is the employee’s Spouse and/or Former Spouse be
                            ...
                            <div class="dropdown">
                                ...
                                <select id="survior_benefit_fers" name="survior_benefit_fers" class="form-select" disabled>
                            ...
                            <div>
                                <input type="text" name="survior_benefit_csrs" id="survior_benefit_csrs" class="tableInput w-50 numberInput"
                ...
                <table id="table-nine" class="table">
                    ...
                    <tr class="dataTr">
                        <td>What age does the employee estimate begin SS Income? <input type="text" name="amount_2"
                                class="tableInput w-25 numberInput"  oninput="validateMinValue(this)">
            ...
            <table id="table-fourteen" class="table">
                ...
                <tr class="dataTr">
                    ...
                    <td colspan="2">$<input type="text" name="contribute_tsp_pp" id="contribute_tsp_pp"
                            class="tableInput  w-50">/PP </td>
                    <td colspan="2"><input type="text" name="contribute_tsp_pp_percentage" id="contribute_tsp_pp_percentage"
                            class="tableInput  w-50">% /PP </td>
                </tr>
                <tr class="dataTr">
        ...
        <div class="col-sm-12 col-md-6">
            <table id="table-eighteen" class="table">
                ...
                <tr class="dataTr">
                    <td>G</td>
                    <td><input type="number" name="g_name" id="g_name" class="tableInput w-100 number-input"></td>
                    <td><input type="number" name="g_value" id="g_value" class="tableInput w-75 percentage-input " placeholder=""> %</td>
                </tr>
                <tr class="dataTr">
                    <td>F</td>
                    <td><input type="number" name="f_name" id="f_name" class="tableInput w-100 number-input"></td>
                    <td><input type="number" name="f_value" id="f_value" class="tableInput w-75 percentage-input " placeholder=""> %</td>
                </tr>
                <tr class="dataTr">
                    <td>C</td>
                    <td><input type="number" name="c_name" id="c_name" class="tableInput w-100 number-input"></td>
                    <td><input type="number" name="c_value" id="c_value" class="tableInput w-75 percentage-input " placeholder=""> %</td>
                </tr>
                <tr class="dataTr">
                    <td>S</td>
                    <td><input type="number" name="s_name" id="s_name" class="tableInput w-100 number-input"></td>
                    <td><input type="number" name="s_value" id="s_value" class="tableInput w-75 percentage-input " placeholder=""> %</td>
                </tr>
                <tr class="dataTr">
                    <td>I</td>
                    <td><input type="number" name="i_name" id="i_name" class="tableInput w-100 number-input"></td>
                    <td><input type="number" name="i_value" id="i_value" class="tableInput w-75 percentage-input " placeholder=""> %</td>
                </tr>
                <tr class="dataTr">
                    <td>L Income</td>
                    <td><input type="number" name="l_income" id="l_income" class="tableInput w-100 number-input"></td>
                    <td><input type="number" name="l_income_value" id="l_income_value" class="tableInput w-75 percentage-input" placeholder=""> %</td>
                </tr>
                <tr class="dataTr">
                    <td>L 2025</td>
                    <td><input type="number" name="l_2025" id="l_2025" class="tableInput w-100 number-input"></td>
                    <td><input type="number" name="l_2025_value" id="l_2025_value" class="tableInput w-75 percentage-input " placeholder=""> %</td>
                </tr>
                <tr class="dataTr">
                    <td>L 2030</td>
                    <td><input type="number" name="l_2030" id="l_2030" class="tableInput w-100 number-input"></td>
                    <td><input type="number" name="l_2030_value" id="l_2030_value" class="tableInput w-75 percentage-input " placeholder=""> %</td>
                </tr>
                <tr class="dataTr">
                    <td>L 2035</td>
                    <td><input type="number" name="l_2035" id="l_2035" class="tableInput w-100 number-input"></td>
                    <td><input type="number" name="l_2035_value" id="l_2035_value" class="tableInput w-75 percentage-input " placeholder=""> %</td>
                </tr>
                <tr class="dataTr">
                    <td>L 2040</td>
                    <td><input type="number" name="l_2040" id="l_2040" class="tableInput w-100 number-input"></td>
                    <td><input type="number" name="l_2040_value" id="l_2040_value" class="tableInput w-75 percentage-input" placeholder=""> %</td>
                </tr>
                <tr class="dataTr">
                    <td>L 2045</td>
                    <td><input type="number" name="l_2045" id="l_2045" class="tableInput w-100 number-input"></td>
                    <td><input type="number" name="l_2045_value" id="l_2045_value" class="tableInput w-75 percentage-input " placeholder=""> %</td>
                </tr>
                <tr class="dataTr">
                    <td>L 2050</td>
                    <td><input type="number" name="l_2050" id="l_2050" class="tableInput w-100 number-input"></td>
                    <td><input type="number" name="l_2050_value" id="l_2050_value" class="tableInput w-75 percentage-input" placeholder=""> %</td>
                </tr>
                <tr class="dataTr">
                    <td>L 2055</td>
                    <td><input type="number" name="l_2055" id="l_2055" class="tableInput w-100 number-input"></td>
                    <td><input type="number" name="l_2055_value" id="l_2055_value" class="tableInput w-75 percentage-input" placeholder=""> %</td>
                </tr>
                <tr class="dataTr">
                    <td>L 2060</td>
                    <td><input type="number" name="l_2060" id="l_2060" class="tableInput w-100 number-input"></td>
                    <td><input type="number" name="l_2060_value" id="l_2060_value" class="tableInput w-75 percentage-input" placeholder=""> %</td>
                </tr>
                <tr class="dataTr">
                    <td>L 2065</td>
                    <td><input type="number" name="l_2065" id="l_2065" class="tableInput w-100 number-input"></td>
                    <td><input type="number" name="l_2065_value" id="l_2065_value" class="tableInput w-75 percentage-input" placeholder=""> %</td>
                </tr>
                <tr class="dataTr">
                    <td>Total</td>
            ...
            <table id="table-nineteen" class="table">
                ...
                <tr class="dataTr">
                    ...
                    <td>What coverage does the employee have?<br>
                        <div>
                            <input type="checkbox" name="insurance_coverage_basic_option" value="basic_option" class="me-2"
                                id="bs">
                        ...
                        <div>
                            <input type="checkbox" name="insurance_coverage_a_option" value="a_option" class="me-2"
                                id="opa">
                            <label for="opa">Option A</label>
                        </div>
                        <div>
                            <input type="checkbox" name="insurance_coverage_b_option" value="b_option" class="me-2"
                                id="obx">
                            <label for="obx">Option B x</label> <input type="number" name="option_b_value"
                                min="1" max="5" class="tableInput w-25">
                        </div>
                        <div>
                            <input type="checkbox" name="insurance_coverage_c_option" value="c_option" class="me-2"
                                id="ocx">
            ...
            jQuery.ajax({
                ...
                success: function(response) {
                    ...
                    if (response["status"] == true) {
                        ...
                        $("#retirementSystemError").removeClass('is-invalid').siblings('p')
                            .removeClass('invalid-feedback').html("");
